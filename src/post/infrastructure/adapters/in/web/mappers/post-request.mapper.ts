...
{
    public static listThreadsCommand(query: ListThreadsQueryRequest): ListThreadsCommand 
    {
    ...
    public static createPostCommand(body: CreatePostRequest): CreatePostCommand
    {
    ...
    public static updatePostCommand(id: string, body: UpdatePostRequest): UpdatePostCommand
    {
