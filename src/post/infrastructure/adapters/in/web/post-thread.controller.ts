...
import { ApiForbiddenResponse, ApiInternalServerErrorResponse, ApiOkResponse, ApiOperation, ApiTags, ApiUnauthorizedResponse } from "@nestjs/swagger";
import { Request, Response } from "express";
import { AuthGuard } from "src/auth/infrastructure/adapters/in/web/handlers/auth.guard";
import { Pagination } from "src/common/common.repository";
import { ErrorResponse } from "src/common/web/common-error.response";
import { ListThreadsUseCase, ListThreadsUseCaseProvider } from "src/post/application/ports/in/use-cases/list-threads.use-case";
...
export class PostThreadController 
{
    ...
    @UseGuards(AuthGuard)
    @Get()
    public async list(@Query() query: ListThreadsQueryRequest, @Req() req: Request, @Res() res: Response) 
    {
