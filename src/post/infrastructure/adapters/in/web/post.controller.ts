import { Body, Controller, Delete, Get, HttpStatus, Inject, Param, Post, Put, Req, Res, UseFilters, UseGuards, UsePipes, ValidationPipe } from "@nestjs/common";
import { ApiForbiddenResponse, ApiInternalServerErrorResponse, ApiNoContentResponse, ApiNotFoundResponse, ApiOkResponse, ApiOperation, ApiTags, ApiUnauthorizedResponse } from "@nestjs/swagger";
import { Request, Response } from "express";
import { AuthGuard } from "src/auth/infrastructure/adapters/in/web/handlers/auth.guard";
import { ErrorResponse } from "src/common/web/common-error.response";
import { AddPostAttachmentUseCase, AddPostAttachmentUseCaseProvider } from "src/post/application/ports/in/use-cases/add-post-attachment.use-case";
import { CreatePostUseCase, CreatePostUseCaseProvider } from "src/post/application/ports/in/use-cases/create-post.use-case";
import { DeletePostUseCase, DeletePostUseCaseProvider } from "src/post/application/ports/in/use-cases/delete-post.use-case";
import { GetPostUseCase, GetPostUseCaseProvider } from "src/post/application/ports/in/use-cases/get-post.use-case";
import { RemovePostAttachmentUseCase, RemovePostAttachmentUseCaseProvider } from "src/post/application/ports/in/use-cases/remove-post-attachment.use-case";
import { UpdatePostUseCase, UpdatePostUseCaseProvider } from "src/post/application/ports/in/use-cases/update-post.use-case";
...
export class PostController 
{
    ...
    @Post()
    public async create(@Body() body: CreatePostRequest, @Req() req: Request, @Res() res: Response) 
    {
    ...
    @UsePipes(new ValidationPipe({ transform: true }))
    @Put(':id')
    public async update(@Param('id') id: string, @Body() Body, @Req() req: Request, @Res() res: Response) 
    {
