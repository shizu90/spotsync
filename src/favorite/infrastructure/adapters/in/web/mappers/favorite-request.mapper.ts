...
export class FavoriteRequestMapper {
    ...
    public static unfavoriteCommand(subject: FavoritableSubject, subject_id: string): FavoriteCommand {
        return new FavoriteCommand(subject, subject_id);
    }

    public static listFavoritesCommand(query: ListFavoritesQueryRequest): ListFavoritesCommand {
