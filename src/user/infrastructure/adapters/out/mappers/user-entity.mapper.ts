import {
	UserCredentials as UserCredentialsPrisma,
	User as UserPrisma,
	UserProfile as UserProfilePrisma,
	UserVisibilitySettings as UserVisibilitySettingsPrisma,
} from '@prisma/client';
...
export type UserEntity = UserPrisma & {
	profile?: UserProfilePrisma;
	credentials?: UserCredentialsPrisma;
	visibility_settings?: UserVisibilitySettingsPrisma;
};
		...
		return User.create(
			...
			entity.visibility_settings
				? UserVisibilitySettings.create(
						...
						entity.visibility_settings
							.spot_folders as UserVisibility,
						entity.visibility_settings
							.visited_spots as UserVisibility,
						entity.visibility_settings.posts as UserVisibility,
						entity.visibility_settings
							.favorite_spots as UserVisibility,
						entity.visibility_settings
							.favorite_spot_folders as UserVisibility,
						entity.visibility_settings
							.favorite_spot_events as UserVisibility,
					)
				: null,
