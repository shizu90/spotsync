...
export type ActivationRequestEntity = ActivationRequestPrisma & {
	user?: UserEntity;
};

export class ActivationRequestEntityMapper
	implements EntityMapper<ActivationRequest, ActivationRequestEntity>
{
