...
export type PasswordRecoveryEntity = PasswordRecoveryPrisma & {user?: UserEntity};

export class PasswordRecoveryEntityMapper implements EntityMapper<PasswordRecovery, PasswordRecoveryEntity> {
