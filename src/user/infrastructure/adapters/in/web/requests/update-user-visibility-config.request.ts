...
export class UpdateUserVisibilityConfigRequest {
  ...
  @IsEnum(UserVisibility, {
    message: 'User profile visibility must be PUBLIC, FOLLOWERS or PRIVATE.',
  })
  @IsOptional()
  ...
  @ApiProperty({ required: false })
  @IsEnum(UserVisibility, {
    message: 'User address visibility must be PUBLIC, FOLLOWERS or PRIVATE.',
  })
  @IsOptional()
  ...
  @ApiProperty({ required: false })
  @IsEnum(UserVisibility, {
    message: 'User poi folder visibility must be PUBLIC, FOLLOWERS or PRIVATE.',
  })
  @IsOptional()
