...
export class SpotFolderRequestMapper {
	...
	public static listSpotFoldersCommand(
		query: ListSpotFoldersQueryRequest,
	...
	public static createSpotFolderCommand(
		body: CreateSpotFolderRequest,
	): CreateSpotFolderCommand {
	...
	public static updateSpotFolderCommand(
		id: string,
		body: UpdateSpotFolderRequest,
	) {
	...
	public static removeSpotCommand(
		id: string,
		spotId: string,
	): RemoveSpotCommand {
	...
	public static sortItemsCommand(
		id: string,
		body: SortItemsRequest,
	): SortItemsCommand {
		return new SortItemsCommand(
			id,
			body.spots.map((item) => {
				return {
					spotId: item.spot_id,
