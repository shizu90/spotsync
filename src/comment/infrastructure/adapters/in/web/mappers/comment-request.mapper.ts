...
export class CommentRequestMapper {
    public static listCommentsCommand(query: ListCommentsQueryRequest): ListCommentsCommand {
    ...
    public static createCommentCommand(body: CreateCommentRequest): CreateCommentCommand {
    ...
    public static updateCommentCommand(id: string, body: UpdateCommentRequest): UpdateCommentCommand {
