...
describe("GetGroupHistoryService", () => {
    ...
    beforeAll(() => {
        const { unit, unitRef } = TestBed.create(GetGroupHistoryService).compile();
    ...
    it('should get group history', async () => {
        ...
        groupRepository.paginateLog.mockResolvedValue(new Pagination(
            [GroupLog.create(randomUUID(), authenticatedGroupMember.group(), 'Test log')],
            1,
            0
        ));
