...
import { GetGroupRoleUseCase, GetGroupRoleUseCaseProvider } from "src/group/application/ports/in/use-cases/get-group-role.use-case";
...
export class GroupRoleController 
{
    ...
    public async getById(@Param('id') groupId: string, @Param('role_id') roleId: string, @Req() req: Request, @Res() res: Response) 
    {
