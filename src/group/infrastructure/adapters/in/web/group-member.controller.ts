...
import { AcceptGroupRequestUseCase, AcceptGroupRequestUseCaseProvider } from "src/group/application/ports/in/use-cases/accept-group-request.use-case";
import { ChangeMemberRoleUseCase, ChangeMemberRoleUseCaseProvider } from "src/group/application/ports/in/use-cases/change-member-role.use-case";
import { JoinGroupUseCase, JoinGroupUseCaseProvider } from "src/group/application/ports/in/use-cases/join-group.use-case";
import { LeaveGroupUseCase, LeaveGroupUseCaseProvider } from "src/group/application/ports/in/use-cases/leave-group.use-case";
import { ListGroupMembersUseCase, ListGroupMembersUseCaseProvider } from "src/group/application/ports/in/use-cases/list-group-members.use-case";
import { RefuseGroupRequestUseCase, RefuseGroupRequestUseCaseProvider } from "src/group/application/ports/in/use-cases/refuse-group-request.use-case";
...
export class GroupMemberController 
{
    ...
    {
        const command = GroupMemberRequestMapper.listGroupMembersCommand(groupId, query);
    ...
    @UseGuards(AuthGuard)
    @Post(':id/join')
    public async joinGroup(@Param('id') groupId: string, @Req() req: Request, @Res() res: Response) 
    {
    ...
    @UseGuards(AuthGuard)
    @Delete(':id/leave')
    public async leaveGroup(@Param('id') groupId: string, @Req() req: Request, @Res() res: Response) 
    {
    ...
    public async changeMemberRole(@Param('id') groupId: string, @Param('member_id') memberId: string, @Body() body: ChangeMemberRoleRequest, @Req() req: Request, @Res() res: Response) 
    {
    ...
    public async acceptGroupRequest(@Param('id') groupId: string, @Param('request_id') requestId: string, @Req() req: Request, @Res() res: Response) 
    {
        const command = GroupMemberRequestMapper.acceptGroupRequestCommand(groupId, requestId);
    ...
    public async refuseGroupRequest(@Param('id') groupId: string, @Param('request_id') requestId: string, @Req() req: Request, @Res() res: Response) 
    {
