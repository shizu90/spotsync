...
export class GroupRepositoryImpl implements GroupRepository
{
    ...
    public async paginate(params: PaginateParameters): Promise<Pagination<Group>> 
    {
    ...
    public async paginateLog(params: PaginateParameters): Promise<Pagination<GroupLog>> 
    {
