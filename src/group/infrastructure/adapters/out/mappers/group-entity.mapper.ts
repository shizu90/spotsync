import { Group as GroupPrisma, GroupVisibilitySettings as GroupVisibilitySettingsPrisma } from "@prisma/client";
...
export type GroupEntity = GroupPrisma & {visibility_settings?: GroupVisibilitySettingsPrisma};
...
export class GroupEntityMapper implements EntityMapper<Group, GroupEntity> {
    ...
    public toModel(entity: GroupEntity): Group {
        return Group.create(
            ...
            entity.visibility_settings ? GroupVisibilitySettings.create(
                entity.id,
                entity.visibility_settings.posts as GroupVisibility,
                entity.visibility_settings.spot_events as GroupVisibility,
