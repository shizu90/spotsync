...
export type VisitedSpotEntity = VisitedSpotPrisma & {spot?: SpotEntity, user?: UserEntity}

export class VisitedSpotEntityMapper implements EntityMapper<VisitedSpot, VisitedSpotEntity> {
    ...
    public toEntity(model: VisitedSpot): VisitedSpotEntity {
        return {
            ...
            spot: model.spot() ? this._spotEntityMapper.toEntity(model.spot()) : null,
