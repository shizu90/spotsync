import { SpotAddress as SpotAddressPrisma, SpotPhoto as SpotPhotoPrisma, Spot as SpotPrisma } from "@prisma/client";
...
export type SpotEntity = SpotPrisma & {creator?: UserEntity, address?: SpotAddressPrisma, photos?: SpotPhotoPrisma[] }
...
export class SpotEntityMapper implements EntityMapper<Spot, SpotEntity> {
    ...
    public toModel(entity: SpotEntity): Spot {
        ...
        return Spot.create(
            ...
            entity.address ? SpotAddress.create(
                entity.id,
                entity.address.area,
            ...
            entity.photos.map(photo => SpotPhoto.create(photo.id, photo.file_path)),
