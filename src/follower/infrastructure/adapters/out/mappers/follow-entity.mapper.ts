...
export type FollowEntity = FollowPrisma & {from_user?: UserEntity, to_user?: UserEntity};
...
export class FollowEntityMapper implements EntityMapper<Follow, FollowEntity> {
    ...
    public toEntity(model: Follow): FollowEntity {
        ...
        return {
            ...
            from_user: model.from() ? this._userEntityMapper.toEntity(model.from()) : null,
            to_user: model.to() ? this._userEntityMapper.toEntity(model.to()) : null,
        };
    }
    ...
    public toModel(entity: FollowEntity): Follow {
        ...
        return Follow.create(
            entity.id,
            entity.from_user ? this._userEntityMapper.toModel(entity.from_user) : null,
            entity.to_user ? this._userEntityMapper.toModel(entity.to_user) : null,
