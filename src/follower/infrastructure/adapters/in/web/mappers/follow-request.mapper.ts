...
{
    public static listFollowsCommand(query: ListFollowsQueryRequest): ListFollowsCommand
    {
    ...
    public static listFollowRequestsCommand(query: ListFollowRequestsQueryRequest): ListFollowRequestsCommand 
    {
